...
How the TrackTBI Connectome pipeline relates to other BIDS Apps and connectome tools.

---

## vs QSIPrep / QSIRecon alone

| | QSIPrep + QSIRecon | TrackTBI Connectome |
|--|-------------------|---------------------|
...
TrackTBI **uses** QSIPrep and QSIRecon as Steps 1 and 3.

---

## vs MRtrix3_connectome (BIDS App)

| | MRtrix3_connectome | TrackTBI |
|--|-------------------|----------|
...
| | connectomemapper3 / micapipe | TrackTBI |
|--|------------------------------|----------|
| Focus | General multi-modal connectomics | TBI-oriented structural connectome + disconnectome |
...
Use `dwi_pipeline/` for all new TrackTBI / CIDUR work.
...
- TBI studies with manual lesion masks and disconnectome analysis
...
- Need single Docker pull, no HPC → micapipe, connectomemapper3, or a monolithic image (not yet published for TrackTBI)
