...
├── qsirecon/sub-<ID>/...
├── tracktbi-inpaint/sub-<ID>/ses-<Y>/...
├── tracktbi-connectome/sub-<ID>/connectome/ + disconnectome/
├── tracktbi-qc/sub-<ID>/subject_qc.html
└── tracktbi-nodestrength/reports/sub-<ID>/...
```
