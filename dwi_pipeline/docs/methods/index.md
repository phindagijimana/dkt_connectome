...
| **3.5** | [Lesion-aware ACT](step3_5_lesion_act.md) | MRtrix3 `5ttedit -path` + iFOD2/SIFT2; optional Deep Atropos native 5TT | Bey et al. 2024; Smith et al. 2012 |
| **3.5a** | [Deep Atropos native-T1 5TT](../deep_atropos_5tt.md) | `dkt_deep_atropos_seg.sif` + `dkt_deep_atropos.sif` (optional branch) | Sensitivity vs HSVS ACPC |
...
- [Deep Atropos native-T1 5TT](../deep_atropos_5tt.md) — optional Step 3.5a-seg / 3.5a branch
