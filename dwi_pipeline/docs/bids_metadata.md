...
Calibrated against TrioTim sidecars where dcm2niix exported full PE metadata (e.g. **sub-SUBJ02**). Prefer §4 formulas anchored on vendor TRT when available.
...
Template: [`bids_repair_subjects.template.csv`](https://github.com/phindagijimana/dkt_connectome/blob/main/dwi_pipeline/config/bids_repair_subjects.template.csv)
