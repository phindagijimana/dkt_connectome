# Field maps and QSIPrep susceptibility distortion correction (SDC)
...
- PE / TRT / `IntendedFor` sidecar repair: [`bids.md`](bids.md)
- Pipeline launcher: [`dwi_pipeline/README.md`](dwi_pipeline/README.md)
- Repair scripts: [`dwi_pipeline/scripts/run_bids_repair.sh`](dwi_pipeline/scripts/run_bids_repair.sh)
...
QSIPrep reads **`PhaseEncodingDirection` + `TotalReadoutTime` from the target DWI JSON** (not from fmap alone). See [`bids.md`](bids.md) §2.
